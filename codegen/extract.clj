...
(let [out (fs/path "codegen" "input")]
  ...
  (let [hooks (extract-hook-docs (slurp (str (fs/path mdx-dir "mdx-hooks-data.ts"))))]
    (spit (str (fs/path out "hook-docs.edn"))
          (with-out-str
            (println ";; GENERATED by `bb extract` from mdx-hooks-data.ts (Mantine 9.4.1) — do not edit.")
            (prn hooks)))
  ...
  (let [components (apply merge
    ...
    (spit (str (fs/path out "component-docs.edn"))
          (with-out-str
            (println ";; GENERATED by `bb extract` from mdx-{core,dates,charts}-data.ts (Mantine 9.4.1) — do not edit.")
